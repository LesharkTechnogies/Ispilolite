...
func (s *UserService) GetTechniciansByISPID(id string)([]*models.User,error){return s.repo.GetTechniciansByISPID(id)}
func (s *UserService) GetUsersByStatus(status string)([]*models.User,error){return s.repo.GetUsersByStatus(status)}
func (s *UserService) RequestDeleteUser(id,status string)error{return s.repo.RequestDeleteUser(id,status)}
