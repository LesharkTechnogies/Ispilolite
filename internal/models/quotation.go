...
type QuotationUnit struct { ID string `json:"id"`; Name string `json:"name"`; SingularName string `json:"singular_name"`; PluralName string `json:"plural_name"`; Symbol string `json:"symbol"`; IsSystem bool `json:"is_system"` }
type TaxRate struct { ID string `json:"id"`; Name string `json:"name"`; Rate float64 `json:"rate"`; IsDefault bool `json:"is_default"` }
